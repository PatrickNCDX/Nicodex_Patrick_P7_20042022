                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="row modal-body">
                        <div class="col-12 justify-content-center form-group">
                            ...
                            <textarea class="form-control" v-model="editComment" id="editComment" name="comment"
                                rows="10" placeholder="Votre commentaire ici..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <div class="row w-100 justify-content-spacebetween">
                            <div class="col-6"><a :href="messageId" class="btn btn-secondary btn-block">Annuler</a>
                            </div>
                            <div class="col-6"><button type="submit" @click.prevent="updateComment()"
