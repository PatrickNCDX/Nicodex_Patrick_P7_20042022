                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="row modal-body">
                        <div class="col-12 justify-content-center form-group">
                            ...
                            <textarea class="form-control" v-model="editMessage" id="editMessage" name="message"
                                rows="10" placeholder="Votre message ici..."></textarea>
                        </div>
                    ...
                    <div class="modal-footer">
                        <div class="row w-100 justify-content-spacebetween">
                            <div class="col-6"><a href="#/messages" class="btn btn-secondary btn-block">Annuler</a>
                            </div>
                            <div class="col-6"><button type="submit" @click.prevent="updateMessage()"
